/**
 * MyPet QR Code Generator
 * Lightweight, zero-dependency QR Code generator (Model 2, Byte Mode, Level M / L).
 * Generates SVG elements or HTML Canvas objects for pet collar tags.
 */
      ...
      for (var r = 0; r < count; r++) {
        for (var c = 0; c < count; c++) {
          if (qr.isDark(r, c)) {
            var x = c + margin;
            var y = r + margin;
            rects.push('<rect x="' + x + '" y="' + y + '" width="1.02" height="1.02" rx="0.12" fill="' + darkColor + '" />');
          }
        }
      }
      
      return (
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ' + viewBoxSize + ' ' + viewBoxSize + '" width="' + size + '" height="' + size + '" shape-rendering="geometricPrecision">' +
